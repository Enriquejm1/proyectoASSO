...
@Component({
  selector: 'app-materia-trigonometria',
  templateUrl: './materia-trigonometria.component.html',
  styleUrls: ['./materia-trigonometria.component.css']
})
export class MateriaTrigonometriaComponent {
