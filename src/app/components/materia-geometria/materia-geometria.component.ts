...
@Component({
  selector: 'app-materia-geometria',
  templateUrl: './materia-geometria.component.html',
  styleUrls: ['./materia-geometria.component.css']
})
export class MateriaGeometriaComponent {
